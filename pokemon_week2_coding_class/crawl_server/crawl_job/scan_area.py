...
SQS_QUEUE_NAME = "awseb-e-dfkwfpasi2-stack-AWSEBWorkerQueue-1TGGWSOTUPLZU"
...
def break_down_area_to_cell(north, south, west, east):
    ...
    cell_ids = region.get_covering(s2sphere.LatLngRect.from_point_pair(p1, p2))#get all cell ids in this region covered by the rect
...
if __name__ == '__main__':
    print json.dumps(scan_area(41, 40.79, -74, -73.99), indent = 4)
